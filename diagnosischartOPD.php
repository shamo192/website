...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $dataPoints[] = array("label" => $row['diagnosis'], "y" => $row['count']);
    ...
    <script>
        window.onload = function() {
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                title: {
                    text: "Out Patient Diagnosis Mode Distribution for <?php echo $currentYear; ?>"
                },
                subtitles: [{
...
<body>
    ...
    <div class="container">
        <h1 class="mt-4 mb-4 text-center">Out patient diagnosis Count for <?php echo $currentYear; ?></h1>

        <!-- Total Animal Bite Cases -->
        <div class="total-cases text-center">
            Total of Patient diagnosis Cases for <?php echo $currentYear; ?>: <?php echo $totalBiteCases; ?>
        </div>
